...
/**
 * 市場コード（先物ＯＰ注文発注用）。
 * @see io.swagger.client.model.RequestSendOrderDerivFuture.exchange:注文発注（先物）情報／市場コード。
 * @see io.swagger.client.model.RequestSendOrderDerivOption.exchange:注文発注（オプション）情報／市場コード。
 */
