 ...
 * 執行条件コード。
 * 
 * @see io.swagger.client.model.RequestSendOrderDerivFuture.frontOrderType:注文発注（先物）情報／執行条件。
 * @see io.swagger.client.model.RequestSendOrderDerivOption.frontOrderType:注文発注（オプション）情報／執行条件。
 */
